Códigos em PHP que exibem os cursos de uma escola. O projeto inclui uma API que pode ser acessada pelo arquivo api.php, possibilitando o uso do projeto como um microservice
